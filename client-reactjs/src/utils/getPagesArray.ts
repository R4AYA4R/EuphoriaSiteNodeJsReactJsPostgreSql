...
export const getPagesArray = (totalPages: number, page: number) => {
    ...
    if (totalPages > 3) {
        ...
        if (page > 2) {
            ...
            // пока i = текущая страница минус 2,увеличивать i на 1,до того,как i будет меньше или равно текущей странице + 1(то есть если текущая страница 3,то сразу i = 3-2=1,и это 1 поместилась в массив этих страниц(result),потом i = 3-2=1 и увеличить i на 1,то есть теперь уже i = 2 и она помещается в массив и так далее в данном случае до того,как i будет равно page + 1(то есть 4 в данном случае) или если i будет равно totalPages(максимальному количеству страниц)),в итоге при изменении страницы массив страниц каждый раз обновляется проходя этот цикл
        ...
        // в другом случае,если общее количество страниц меньше или равно 3,то i = 0,увеличивать i на 1 до того,как i будет меньше общего количества страниц и записывать каждый раз эту i в массив страниц(result),но увеличенную на 1,чтобы массив начинался не с 0,а с 1
