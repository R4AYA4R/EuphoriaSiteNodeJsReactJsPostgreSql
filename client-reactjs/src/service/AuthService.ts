...
// создаем и экспортируем наш класс AuthService
export default class AuthService {
    ...
    static async logout():Promise<void> {
        ...
        $api.post('/logout');  // используем наш instance axios(наш axios с определенными настройками для работы) и указываем здесь post(post запрос) на эндпоинт /logout для выхода из аккаунта
