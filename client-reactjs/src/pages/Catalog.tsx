...
const Catalog = () => {
    ...
    const addFilterSizeM = () => {
        ...
        if (!sizesMass.some(item => item === 'M')) {
            ...
            // в другом случае,если этот элемент('M') уже есть,то оставляем все элементы в массиве sizesMass,которые не равны значению 'M',то есть удаляем этот элемент 'M' из массива sizesMass
