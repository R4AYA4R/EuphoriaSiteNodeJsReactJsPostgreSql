...
// указываем тип объекта пропсов(параметров) этого компонента как тип на основе нашего интерфейса ISectionUnderTopProductPage
const SectionUnderTopProductPage = ({productName}:ISectionUnderTopProductPage) => {
        ...
        <section id="sectionCategories" className={onScreen.sectionCategoriesIntersecting ? "sectionCategories sectionCategories__active sectionUnderTop" : "sectionCategories sectionUnderTop"} ref={sectionCategories}>
            <div className="container">
                <div className="sectionUnderTop__inner">
                    ...
                    <p className="sectionUnderTop__subtext">Shop</p>
                    <img src="/images/sectionUnderTop/rightArrow.png" alt="" className="sectionUnderTop__img" />
                    <p className="sectionUnderTop__subtext">{productName}</p>
                </div>
            </div>
        </section>
    )
...
export default SectionUnderTopProductPage;