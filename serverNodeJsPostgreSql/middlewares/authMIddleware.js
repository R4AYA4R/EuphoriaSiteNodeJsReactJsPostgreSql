...
export default function (req,res,next){
    ...
    try{
        ...
        // если authorizationHeader false(или null,или другое пустое или false значение),то есть этот header(заголовок) с токеном не указан
        ...
        // если accessToken false(или null,или другое пустое или false значение),то есть accessToken нету
        if(!accessToken){
        ...
        // если userData false(или null,или другое пустое или false значение),то есть если в userData ничего нет(если наша функция validateAccessToken вернула null при верификации)
        if(!userData){
